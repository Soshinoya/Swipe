...
const commentsData = [
    {
        name: 'Joe Smith',
        comment: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut fringilla interdum aliquet. Nulla viverra quam sit amet lacus accumsan, ac interdum nibh eleifend.',
        photo: commentPeopleImg,
        position: 'CEO at Flatty',
        rate: 4,
        social: [
            <i className="comments-item__link fab fa-linkedin-in"></i>,
            <i className="comments-item__link fab fa-facebook-f"></i>,
            <i className="comments-item__link fab fa-twitter"></i>
        ]
    },
    {
        name: 'Joe',
            ...
            <div ref={container} className="container">
                ...
                <div className="comments-slider">
                    <Carousel
                        ...
                        {commentsData.map(({ name, comment, photo, position, rate, social }, i) => (
                            <Carousel.Item key={i}>
                                <div className="comments-item glassmorphic-bg">
                                    ...
                                    <div className="d-flex align-items-baseline justify-content-between">
                                        <ul className="comments-item__links d-flex align-items-center">
                                            {social.map((elem, i) => <li key={i}>{elem}</li>)}
                                        </ul>
